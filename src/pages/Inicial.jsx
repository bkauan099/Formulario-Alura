  ...
  return (
    <div className="bg-[#222061] flex flex-col justify-center items-center max-w-[1000px] w-full min-h-[500px] mx-auto mt-50 rounded-2xl shadow-lg p-6">
      ...
      <div className="relative w-full flex justify-center mt-10">
        <img className="w-[80px] sm:w-[100px] absolute left-4 sm:left-10 bottom-[-100px] hidden sm:block" src="./src/assets/Camada_1.png" alt="Imagem 1" />
      ...
      {/* Botão de Envio */}
        <button onClick={() => navigate("/home")} className="bg-[#1b1a4b] text-white rounded-[10px] cursor-pointer px-4 py-2 mt-10 w-[12.5rem] hover:bg-[#2c2a7f] transition">
          Enviar Dados
        </button>
